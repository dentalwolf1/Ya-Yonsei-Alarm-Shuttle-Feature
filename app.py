...
# Sends SMS at 13:50 and 13:55, two days before the ride date
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Input pattern
# User always types: 01012345678 06/10
# ---------------------------------------------------------------------------

FORMAT_HELP = (
    "입력 형식: 전화번호 월/일\n"
    "예시: 01012345678 06/10\n"
    "예시: 01012345678 6월10일\n\n"
    "• 탑승일 2일 전 13:50, 13:55에 예약 알림 SMS 발송"
)

# 01012345678 06/10 or 01012345678 6월10일
